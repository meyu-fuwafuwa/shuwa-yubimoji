// JavaScript Document
let data = new Array();
data.push(["おはようございます","こんにちは","おはようございます","ありがとう","はじめまして"]);
data.push(["こんにちは","こんばんは","はじめまして","こんにちは","ごめんなさい"]);
data.push(["こんばんは","こんばんは","こんにちは","おはようございます","よろしくおねがいします"]);
data.push(["はじめまして","こんにちは","ありがとう","ごめんなさい","はじめまして"]);
data.push(["ありがとう","はじめまして","ありがとう","ごめんなさい","よろしくおねがいします"]);
data.push(["ごめんなさい","おはようございます","ごめんなさい","はじめまして","こんにちは"]);
data.push(["よろしくおねがいします","よろしくおねがいします","こんにちは","ごめんなさい","たのしい"]);
...
function questionSet(){
	...
	let msg = "";
	msg = "<video src='./movie-shuwa1/"+word+".mp4'  poster='読み込み中.jpg' playsinline autoplay muted loop></video>";
